...
<body class="bg-gray-200 ">
    ...
    <main class="flex justify-center">
            <form method="POST" class="p-12 pb-10 pt-1.5 h-3/4 bg-white mt-20 grid grid-cols-1 gap-4 rounded-lg shadow-xl">
                <img class="ml-20 my-3 rounded w-20" src="eeese.jpg" alt="forbes-logo">
                <h1 class="ml-20 font-bold text-xl">Hyphens</h1>
                <input name="lecname"  type="text" class="border border-gray-300 rounded-md w-64 h-9 mt-0 pl-4 hover:border-gray-400 hover:placeholder-gray-600 focus:border-sky-500 focus:outline-none focus:ring-1" placeholder="Leacturer Name" id="email" require>
...
<?php
    ...
    if(isset($_POST['sin'])) {
        $getlecname = $_POST['lecname'];
        $getpassword = $_POST['password'];

        if($lecname === $getlecname && $password === $getpassword) {
            header("Location:sjncj.html");
        ...
        echo "<h3>cheak your name and your password</h3>";
    }
